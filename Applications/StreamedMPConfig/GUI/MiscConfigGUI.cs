...
namespace StreamedMPConfig
{
    public class MiscConfigGUI : GUIWindow
    {
        ...
        private enum GUIControls
        {
            ...
            IgnoreParentalControlsInMostRecents = 14
        }
        #endregion
        ...
        [SkinControl((int)GUIControls.IgnoreParentalControlsInMostRecents)]
        protected GUICheckButton btnIgnoreParentalControlsInMostRecents = null;
        #endregion
        ...
        public static bool IgnoreParentalControlInRecentlyAdded { get; set; }
        ...
        private void SetControlStates()
        {
            ...
            // Ignore Parental Control Filters in Most Recents
            btnIgnoreParentalControlsInMostRecents.Selected = IgnoreParentalControlInRecentlyAdded;
            btnIgnoreParentalControlsInMostRecents.Label = Translation.IgnoreParentalFilterInMostRecents;
        ...
        private void GetControlStates()
        {
            ...
            // on MovingPictures has this option currently
            if (IgnoreParentalControlInRecentlyAdded != btnIgnoreParentalControlsInMostRecents.Selected)
            {
                IgnoreParentalControlInRecentlyAdded = btnIgnoreParentalControlsInMostRecents.Selected;
                StreamedMPConfig.getLastThreeAddedMovies();
            }
        }
