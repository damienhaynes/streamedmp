...
namespace StreamedMPConfig
{
    class settings
    {
        ...
        public const string cXMLSettingMiscTextualLogos = "miscUseTextLogos";
        public const string cXMLSettingMyVideoWatchedProgress = "miscShowMyVideoWatchedProgress";
        public const string cXMLSettingIgnoreParentalControlInRecentlyAdded = "miscIgnoreParentalControlInRecentlyAdded";
            ...
            using (MediaPortal.Profile.Settings xmlreader = new MediaPortal.Profile.Settings(Config.GetFile(Config.Dir.Config, "StreamedMPConfig.xml")))
            {
                ...
                switch (section)
                {
                    ...
                    case settings.cXMLSectionMisc:
                        ...
                        MiscConfigGUI.IgnoreParentalControlInRecentlyAdded = xmlreader.GetValueAsInt(section, settings.cXMLSettingIgnoreParentalControlInRecentlyAdded, 0) == 1;
                    break;
                        #endregion
            ...
            using (MediaPortal.Profile.Settings xmlwriter = new MediaPortal.Profile.Settings(Config.GetFile(Config.Dir.Config, "StreamedMPConfig.xml")))
            {
                switch (section)
                {
                    ...
                    case settings.cXMLSectionMisc:
                        ...
                        xmlwriter.SetValue(section, settings.cXMLSettingIgnoreParentalControlInRecentlyAdded, MiscConfigGUI.IgnoreParentalControlInRecentlyAdded ? 1 : 0);
                        break;
                        #endregion
