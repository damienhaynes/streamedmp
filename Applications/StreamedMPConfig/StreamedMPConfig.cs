...
namespace StreamedMPConfig
{
    ...
    public class StreamedMPConfig : GUIWindow, ISetupForm
    {
        ...
        {
            smcLog.WriteLog(string.Format("Get Most Recent Watched Movies: Ignore Parental Filter: {0}",
                            MiscConfigGUI.IgnoreParentalControlInRecentlyAdded ? "Enabled" : "Disabled"),
                            LogLevel.Info);
            ...
            bool pcFilterEnabled = MovingPicturesCore.Settings.ParentalControlsEnabled && !MiscConfigGUI.IgnoreParentalControlInRecentlyAdded;
        ...
        {
            smcLog.WriteLog(string.Format("Get Most Recent Added Movies: Exclude Watched {0}, Ignore Parental Filter: {1}", 
                            MiscConfigGUI.FilterWatchedInRecentlyAdded ? "Enabled" : "Disabled", 
                            MiscConfigGUI.IgnoreParentalControlInRecentlyAdded ? "Enabled" : "Disabled"), 
                            LogLevel.Info);
