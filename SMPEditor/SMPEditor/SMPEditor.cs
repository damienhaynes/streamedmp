...
namespace SMPEditor
{
  [PluginIcons("SMPEditor.Resources.SMPEditor.png", "SMPEditor.Resources.SMPEditorDisabled.png")]

  public partial class SMPEditor : Form, IPlugin, ISetupForm
    {
        ...
        private void LoadPrettyItems()
        {
            ...
            Stream stream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("SMPEditor.xmlFiles.QuickSelectList.xml");
